<%-- 
    Document   : pglibromayor
    Created on : 03-abr-2017, 15:06:35
    Author     : Sinergia003
--%>
            ...
            <div class="tab" role="tabpanel">
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="Section1">
                        ...
                        <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4">
                            <div class="form-group">
                                <label for="pnestudiante">Fecha Inicial:</label>
                                <input maxlength="120" type="text" class="form-control gui-input" id="pnestudiante" placeholder="Primer nombre" data-bv-trigger="keyup" required data-bv-notempty-message="Campo obligatorio" />
                        ...
                        <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4">
                            ...
                            <div class="form-group">
                                <label for="snestudiante">Fecha Final:</label>
                                <input  class="gui-input form-control" maxlength="120" type="text" id="fechafinal" name="">
                            </div> 
                        </div>
                        <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                    <button type="submit" class="btn btn-lg btn-primary btn-block"><span class="glyphicon glyphicon-list-alt"></span> Generar Filtos</button>
                                </div>
                            </div>
                        </div> 
                        </div>
