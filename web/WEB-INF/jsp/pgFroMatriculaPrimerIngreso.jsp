<%-- 
    Document   : pgFroMatriculaPrimerIngreso
    Created on : 13-mar-2017, 8:07:34
    Author     : Sinergia14
--%>
    ...
    <section id="content_wrapper">
        <section id="content" class="animated fadeIn">
                <div class="content-header">
                    <h2><b class="text-success">Primer Ingreso</b></h2>
                    
                </div>
                <div class="row">
                    <div class="col-md-12 well">
                        <a class="btn btn-primary" href="formulario.gdc"><i class="fa fa-fw -square -circle fa-plus-square"></i> Solicitar nueva inscripción</a>
                    </div>
                </div>
                <div class="section">
            <div class="container">
                        ...
                        <table class="table table-hover table-striped">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img src="<c:url value='/resources/img/logoDelCampo.png'/>" class="img-responsive" width="80">
                                    </td>
                                    <td>
                                        <h4>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button class="btn btn-default" value="right" type="button">
                                                <i class="fa fa-fw fa-cog"></i>Modificar</button>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                         <img src="<c:url value='/resources/img/logoAcademy.png'/>" class="img-responsive" width="80">
                                    </td>
                                    <td>
                                        <h4>
                                            <b>Claudia Ramos</b>
