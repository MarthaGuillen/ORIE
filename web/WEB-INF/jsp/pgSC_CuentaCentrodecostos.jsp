                        ...
                        <div class="panel-body bg-light">
                            <form  id="form-ui">
                                     ...
                                     <div class="col-md-6">
                                        <div class="section">
                                          <label class="field select">
                                               <select class="form-control" name="CATALOGO" id="area">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <div class="section">
                                          <label class="field select">
                                             <select class="form-control" name="CATALOGO" id="departamento">
                                ...
                                <div class="panel-footer text-right">
                                    <button type="button" class="button btn-primary" class="t" onclick="validarcentrocosto()"> Validate Form </button>
